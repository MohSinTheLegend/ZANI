...
\033[1;94m➣ YOUTUBE  : ZAIN CREATION
\033[1;91m➣ WARNING  : DON'T TRY TO COPY ☠
\033[1;93m FACEBOOK   : ZANI KOJA 💛
\033[1;92m ========================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;92mWHATSAPP \033[1;93m: \033[1;91m+923096372***
\033[1;92mUTUBE  \033[1;93m: \033[1;94mZAIN CREATION
\033[1;91m======================================="""
print " \x1b[1;97m=========================================="
CorrectUsername = "ZANI"
CorrectPassword = "KOJA"
loop = 'true'
while (loop == 'true'):
...
def pilih_super():
	...
	print("\033[1;96m[+] \033[1;92m ZAIN THE BRAND \033[1;91m: \033[1;97mout/checkpoint.txt")
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	menu()
